...
.radio-group {
    ...
    gap: 20px; /* ラジオボタン間のスペース */
    margin-bottom: 10px;
}

.radio-group label {
    display: inline-block; /* ラベルをインラインブロックとして表示 */
    margin-right: 10px; /* ラベルとラジオボタンの間隔 */
    font-weight: bold; /* ラベルを太字に */
}

.radio-group input[type="radio"] {
    display: inline-block; /* ラジオボタンをインラインブロックとして表示 */
    margin-right: 5px; /* ラジオボタンとテキスト間の余白 */
    margin-left: 0; /* ラジオボタンの左側の余白をゼロに */
}
