...
<div class="main-content">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="radio-group">
            <label>分類</label>
            <span><label for="domestic">国内</label><input type="radio" name="Region" value="0" id="domestic" required></span>
            <span><label for="overseas">海外</label><input type="radio" name="Region" value="1" id="overseas"></span>
        </div>
