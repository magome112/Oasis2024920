...
<div class="main-content">
    ...
    <label>分類</label>
    <span><input type="radio" name="Region" value="0" id="domestic" required><label for="domestic">国内</label></span>
    <span><input type="radio" name="Region" value="1" id="overseas"><label for="overseas">海外</label></span>
</div>
