...
<head>
    ...
    <style>
        ...
        .radio-group {
    display: block; /* ブロック表示で他のフォーム要素と統一 */
    margin-bottom: 10px; /* 他のフィールドとの間隔を統一 */
}

.radio-group label {
    display: block; /* ラベルを上部に配置 */
    margin-bottom: 5px; /* ラベルとラジオボタン間の余白 */
    font-weight: bold; /* 太字でラベルを強調 */
}

.radio-group input[type="radio"] {
    margin-right: 5px; /* ラジオボタンとテキスト間の間隔 */
}
